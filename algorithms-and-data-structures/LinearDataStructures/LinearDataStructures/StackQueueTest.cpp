...
StackQueueTest::StackQueueTest()
{}

//performs ze test!
String^ StackQueueTest::performTest()
{ 
	...
	s += Convert::ToString(passedTests) + "/" + UNITS + " passed";
...
bool StackQueueTest::performIntLinkedListPushTest()
{ 
	//Arrange
...
bool StackQueueTest::performIntLinkedListCountTest()
{
	//Arrange
	IntQueue^ intQueue = gcnew IntQueue();
	int expected = 1;
...
bool StackQueueTest::performIntLinkedListIsEmptyTrueTest()
{ 
	//Arrange
	IntQueue^ intQueue = gcnew IntQueue();
	bool expected = true;
...
//is called on an empty linked list.
bool StackQueueTest::performIntLinkedListIsEmptyFalseTest()
{ 
	//Arrange
	IntQueue^ intQueue = gcnew IntQueue();
	bool expected = false;
...
bool StackQueueTest::performIntQueuePeekEmptyTest()
{ 
	//Arrange
	IntQueue^ intQueue = gcnew IntQueue();
	bool actual = false;
...
bool StackQueueTest::performIntQueuePeekOneTest()
{ 
	//Arrange
	IntQueue^ intQueue = gcnew IntQueue();
	int expected = 0;
...
bool StackQueueTest::performIntQueuePeekManyTest()
{ 
	//Arrange
	IntQueue^ intQueue = gcnew IntQueue();
	int expected = 0;
...
bool StackQueueTest::performIntQueuePeekAfterPopTest()
{ 
	//Arrange
	IntQueue^ intQueue = gcnew IntQueue();
	int expected = 1;
...
bool StackQueueTest::performIntQueueCountAfterPeekTest()
{ 
	//Arrange
	IntQueue^ intQueue = gcnew IntQueue();
	int expected = 3;
...
bool StackQueueTest::performIntQueuePopEmptyTest()
{ 
	//Arrange
	IntQueue^ intQueue = gcnew IntQueue();
	bool actual = false;
...
bool StackQueueTest::performIntQueuePopOneTest()
{ 
	//Arrange
	IntQueue^ intQueue = gcnew IntQueue();
	int expected = 0;
...
bool StackQueueTest::performIntQueuePopManyTest()
{ 
	//Arrange
	IntQueue^ intQueue = gcnew IntQueue();
	int expected = 0;
...
bool StackQueueTest::performIntQueuePopAfterPeekTest()
{ 
	//Arrange
	IntQueue^ intQueue = gcnew IntQueue();
	int expected = 0;	
...
bool StackQueueTest::performIntQueueCountAfterPopTest()
{ 
	//Arrange
	IntQueue^ intQueue = gcnew IntQueue();
	int expected = 2;	
...
bool StackQueueTest::performIntStackPeekEmptyTest()
{ 
	//Arrange
...
bool StackQueueTest::performIntStackPeekOneTest()
{ 
	//Arrange
	IntStack^ intStack = gcnew IntStack();
	int expected = 0;
...
bool StackQueueTest::performIntStackPeekManyTest()
{ 
	//Arrange
	IntStack^ intStack = gcnew IntStack();
	int expected = 2;
...
bool StackQueueTest::performIntStackPeekAfterPopTest()
{ 
	//Arrange
	IntStack^ intStack = gcnew IntStack();
	int expected = 1;
...
//Tests that the IntStack class returns the correct result
//when count is called after a peek.
bool StackQueueTest::performIntStackCountAfterPeekTest()
{ 
	//Arrange
	IntStack^ intStack = gcnew IntStack();
	int expected = 1;
...
bool StackQueueTest::performIntStackPopEmptyTest()
{ 
	//Arrange
	IntStack^ intStack = gcnew IntStack();
	bool actual = false;
...
bool StackQueueTest::performIntStackPopOneTest()
{ 
	//Arrange
	IntStack^ intStack = gcnew IntStack();
	int expected = 0;
...
bool StackQueueTest::performIntStackPopManyTest()
{ 
	//Arrange
	IntStack^ intStack = gcnew IntStack();
	int expected = 2;
...
//Tests that the IntStack class returns the correct result
//When pop is called after a peek.
bool StackQueueTest::performIntStackPopAfterPeekTest()
{ 
	//Arrange
	IntStack^ intStack = gcnew IntStack();
	int expected = 0;
...
//Tests that the IntStack class returns the correct result
//when count is called after a pop.
bool StackQueueTest::performIntStackCountAfterPopTest()
{ 
	//Arrange
	IntStack^ intStack = gcnew IntStack();
	int expected = 2;
...
bool StackQueueTest::performCharLinkedListPushTest()
{ 
	//Arrange
...
bool StackQueueTest::performCharLinkedListCountTest()
{ 
	//Arrange
	CharQueue^ charQueue = gcnew CharQueue();
	int expected = 1;
...
bool StackQueueTest::performCharLinkedListIsEmptyTrueTest()
{ 
	//Arrange
	CharQueue^ charQueue = gcnew CharQueue();
	bool expected = true;
...
bool StackQueueTest::performCharLinkedListIsEmptyFalseTest()
{ 
	//Arrange
	CharQueue^ charQueue = gcnew CharQueue();
	bool expected = false;
...
//when peek is called on an empty queue.
bool StackQueueTest::performCharQueuePeekEmptyTest()
{ 
	//Arrange
	CharQueue^ charQueue = gcnew CharQueue();
	int actual = false;
...
bool StackQueueTest::performCharQueuePeekOneTest()
{ 
	//Arrange
	CharQueue^ charQueue = gcnew CharQueue();
	Char expected = 'c';
...
bool StackQueueTest::performCharQueuePeekManyTest()
{ 
	//Arrange
	CharQueue^ charQueue = gcnew CharQueue();
	Char expected = 'a';
...
//Tests that the CharQueue class returns the correct result
//when peek is called after a pop.
bool StackQueueTest::performCharQueuePeekAfterPopTest()
{
	//Arrange
	CharQueue^ charQueue = gcnew CharQueue();
	Char expected = 'b';
...
//Tests that the CharQueue class returns the correct result
//when count is called after a peek.
bool StackQueueTest::performCharQueueCountAfterPeekTest()
{ 
	//Arrange
	CharQueue^ charQueue = gcnew CharQueue();
	int expected = 3;
...
bool StackQueueTest::performCharQueuePopEmptyTest()
{ 
	//Arrange
	CharQueue^ charQueue = gcnew CharQueue();
	int actual = false;
...
bool StackQueueTest::performCharQueuePopOneTest()
{
	//Arrange
	CharQueue^ charQueue = gcnew CharQueue();
	Char expected = 'c';
...
bool StackQueueTest::performCharQueuePopManyTest()
{
	//Arrange
	CharQueue^ charQueue = gcnew CharQueue();
	Char expected = 'a';
...
//Tests that the CharQueue class returns the correct result
//when pop is called after a peek.
bool StackQueueTest::performCharQueuePopAfterPeekTest()
{
	//Arrange
	CharQueue^ charQueue = gcnew CharQueue();
	Char expected = 'a';
...
//Tests that the CharQueue class returns the correct result
//when count is called after a pop.
bool StackQueueTest::performCharQueueCountAfterPopTest()
{
	//Arrange
	CharQueue^ charQueue = gcnew CharQueue();
	int expected = 0;
...
//when peek is called on an empty stack
bool StackQueueTest::performCharStackPeekEmptyTest()
{
	//Arrange
...
bool StackQueueTest::performCharStackPeekOneTest()
{
	//Arrange
	CharStack^ charStack = gcnew CharStack();
	Char expected = 'a';
...
bool StackQueueTest::performCharStackPeekManyTest()
{
	//Arrange
	CharStack^ charStack = gcnew CharStack();
	Char expected = 'c';
...
//Tests that the CharStack class returns the correct result
//when peek is called after a pop.
bool StackQueueTest::performCharStackPeekAfterPopTest()
{
	//Arrange
	CharStack^ charStack = gcnew CharStack();
	Char expected = 'b';
...
//Tests that the CharStack class returns the correct result
//when count is called after a peek.
bool StackQueueTest::performCharStackCountAfterPeekTest()
{
	//Arrange
	CharStack^ charStack = gcnew CharStack();
	int expected = 1;
...
//Tests that the CharStack class returns NullReferenceException
//when pop is called on an empty stack.
bool StackQueueTest::performCharStackPopEmptyTest()
{ 
	//Arrange
	CharStack^ charStack = gcnew CharStack();
	bool actual = false;
...
bool StackQueueTest::performCharStackPopOneTest()
{
	//Arrange
	CharStack^ charStack = gcnew CharStack();
	Char expected = 'a';
...
bool StackQueueTest::performCharStackPopManyTest()
{ 
	//Arrange
	CharStack^ charStack = gcnew CharStack();
	Char expected = 'c';
...
//Tests that the CharStack class returns the correct result
//when pop is called after a peek.
bool StackQueueTest::performCharStackPopAfterPeekTest()
{ 
	//Arrange
	CharStack^ charStack = gcnew CharStack();
	Char expected = 'b';
...
//Tests that the CharStack class returns the correct result
//when count is called after a pop.
bool StackQueueTest::performCharStackCountAfterPopTest()
{
	//Arrange
	CharStack^ charStack = gcnew CharStack();
	int expected = 0;
